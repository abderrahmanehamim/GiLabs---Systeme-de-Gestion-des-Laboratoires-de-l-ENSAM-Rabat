...
@Controller
public class FileController6 {
	 @Autowired
	  FilesStorageService6 storageService;
		@Autowired
	  ...
	  @GetMapping("/files6/new")
	  public String newFile(Model model) {
			
	    return "addpdf6";
	  }

	  @PostMapping("/files6/upload")
	  ...
	  @GetMapping("/files6/delete/{filename:.+}")
