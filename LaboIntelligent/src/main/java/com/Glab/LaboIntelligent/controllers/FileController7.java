...
@Controller
public class FileController7 {
	 @Autowired
	  FilesStorageService7 storageService;
		@Autowired
	  ...
	  @GetMapping("/files7/new")
	  public String newFile(Model model) {
			
	    return "addpdf7";
	  }

	  @PostMapping("/files7/upload")
	  ...
	  @GetMapping("/files7/delete/{filename:.+}")
