...
@Controller
public class FileController5 {
	 @Autowired
	  FilesStorageService5 storageService;
		@Autowired
	  ...
	  @GetMapping("/files5/new")
	  public String newFile(Model model) {
			
	    return "addpdf5";
	  }

	  @PostMapping("/files5/upload")
	  ...
	  @GetMapping("/files5/delete/{filename:.+}")
